<template>
  <footer class="p-4 bg-color1 text-white text-center">
    ...
    <div class="flex items-center justify-center space-x-2 hover:text-colorText_h1 cursor-pointer">
      <font-awesome-icon :icon="['fas', 'phone']" class="w-6 h-6" />
      <p>(73) 3212-1229</p>
    </div>
    <a href="mailto:sociop@gmail.com" class="flex items-center justify-center space-x-2 mt-2 hover:text-colorText_h1 cursor-pointer">
    ...
    <p class="mt-4 hover:text-colorText_h1 cursor-pointer">Endereço: Rua Francisco Ribeiro Jr., 198, Sala 606 - Centro, Itabuna - BA.</p>
  </footer>
</template>
